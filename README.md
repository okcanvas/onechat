# onechat스프링 부트와 Netty로 작성된 채팅 서버에서 하나의 서버에 최대 접속할 수 있는 사용자 수를 계산하는 방법은 여러 요인에 따라 달라집니다. 서버 사양을 고려하지 않더라도, 네트워크와 애플리케이션의 구조적인 한계 등을 기반으로 이론적인 최대 접속 수를 추정할 수 있습니다. 주요 고려 사항은 다음과 같습니다.
