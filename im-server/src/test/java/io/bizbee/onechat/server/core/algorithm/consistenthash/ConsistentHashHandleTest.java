package io.bizbee.onechat.server.core.algorithm.consistenthash;

import io.bizbee.onechat.common.core.enums.NetProtocolEnum;
import io.bizbee.onechat.server.BaseSpringBootTest;
...
public class ConsistentHashHandleTest extends BaseSpringBootTest {
  ...
  void routeServer2() {
    ...
    for (NodeContainer.WNode n : statistic.keySet()) {
      ...
      log.info("[{}],{},{}", n.toString(), count, count * 1.0 / nodeCount);
    }
  }
